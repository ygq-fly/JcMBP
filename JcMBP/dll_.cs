...
namespace JcMBP
{
    public class ClsJcPimDll
    {
        ...
        public static bool JcSetSwitch(int iSwitchTx1, int iSwitchTx2, int iSwitchPim, int iSwitchDet)
        {
            return true;
        }
        ...
        public static int fnSetTxPower(double dTxPower1, double dTxPower2, double dPowerOffset1, double dPowerOffset2)
        {
            return 0;
        }
        ...
        {
            dFreq = 2 * f1 - f2;
            dPimResult = -122 - new Random(Guid.NewGuid().GetHashCode()).NextDouble()*10 - new Random(Guid.NewGuid().GetHashCode()).NextDouble();
