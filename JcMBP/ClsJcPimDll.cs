...
//JC_API void JcFindRsrc();
    ...
    public class ClsJcPimDll111
    {
        ...
        public static bool JcGetVcoDsp(ref double vco, byte bySwitchBand) { return true; }
        ...
        public static  double JcGetSen() { return 0; }


        public static  double JcGetAna(double freq_khz, bool isMax) { return 0; }
        ...
        public static  bool JcSetSwitch(int iSwitchTx1, int iSwitchTx2,
                                              int iSwitchPim, int iSwitchDet) { return true; }
        ...
        public static  int fnSetInit(string cDeviceAddr) { return 0; }


        public static  int fnSetExit() { return 0; }


        public static  int fnSetMeasBand(byte byBandIndex) { return 0; }

        public static  int HwSetMeasBand(byte byTx1Band, byte byTx2Band, byte byRxBand) { return 0; }


        public static int fnSetImAvg(byte byAvgTime) { return 0; }


        public static  int fnSetDutPort(byte byPort) { return 0; }


        public static  int HwSetDutPort(byte tx1, byte tx2, byte byPort) { return 0; }


        public static  int fnSetImOrder(byte byImOrder) { return 0; }


        public static  int fnSetTxPower(double dTxPower1, double dTxPower2,
                                               double dPowerOffset1, double dPowerOffset2) { return 0; }


        public static  int fnSetTxFreqs(double dCarrierFreq1, double dCarrierFreq2, string cUnits) { return 0; }


        public static  int fnSetTxOn(bool bOn, byte byCarrier = 0) { return 0; }


        public static  int fnGetImResult(ref double dFreq, ref double dPimResult, string cUnits) { return 0; }

        public static  void HwSetCoup(byte byCoup) { }


        public static  double HwGetCoup_Dsp(byte byCoup) { return 0; }


        public static  int HwGetSig_Smooth(ref double dd, byte byCarrier) { return 0; }


        public static  int HwSetTxFreqs(double dCarrierFreq1, double dCarrierFreq2, string cUnits) { return 0; }
        ...
        public static  bool HwGet_Vco(ref double real_val, ref double vco_val) { return true; }

        //poi 设置阶数
        [DllImport(Path, CallingConvention = CallingConvention.Cdecl)]
        public static extern int HwSetImOrder(byte byImOrder, byte byImLow, byte byImLess);

        public static  int JcSetOffsetTxIncremental(byte byInternalBand, byte byDutPort, byte coup, byte setOrread, double Incremental) { return 0; }

        //poi 

        public static int HwSetImCoefficients(byte byImCo1, byte byImCo2, byte byImLow, byte byImLess) { return 0; }
        //------------------------------------------------函数指针--------------------------------------------------------
